...
struct ftl_nv_cache_device_type nvc_bdev_random_group_vss = {
	...
	.ops = {
		...
		.get_user_io_tag = random_chunk_get_user_io_tag,
		.get_group_tag_for_compaction = get_random_group_tag_for_compaction,
		.md_layout_ops = {
...
FTL_NV_CACHE_DEVICE_TYPE_REGISTER(nvc_bdev_random_group_vss)
